...
check('site.ts: latest release fallback is v1.3.1', siteConfig.includes("'v1.3.1'"));
check('site.ts: current release supports redaction', siteConfig.includes('supportsRedaction: true'));
check('site.ts: current release claims version command support', siteConfig.includes('supportsVersionCommand: true'));
...
for (const phrase of [
  ...
  'Cluster health',
  'The selected upgrade operation should not proceed',
