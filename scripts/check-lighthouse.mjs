...
const paths = ['/', '/docs', '/eks-upgrade-readiness', '/kubernetes-upgrade-checklist', '/kubernetes-deprecated-api-checker', '/eks-rollback-readiness', '/kubernetes-upgrade-ci-guide', '/install', '/use-cases', '/github-action', '/case-study/eks-1-31-to-1-32', '/security'];
